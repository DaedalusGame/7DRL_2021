...
namespace _7DRL_2021
{
    ...
    class TextParameters
    {
        ...
        public bool BoldStart;
        public TextColorFunction ColorStart;
        public TextColorFunction BorderStart;
        public TextOffsetFunction OffsetStart;
        public int ScriptOffsetStart;
        public bool UnderlineStart;
        ...
        public void Format(FormatToken format)
        {
            switch (format)
            {
                ...
                case (FormatToken.Superscript):
                    ScriptOffset -= 8;
                    break;
                case (FormatToken.Reset):
                    Color = ColorStart;
                    Border = BorderStart;
                    Offset = OffsetStart;
                    Bold = BoldStart;
                    Underline = UnderlineStart;
                    ScriptOffset = ScriptOffsetStart;
                    break;
            }
        }
        ...
        public TextParameters Copy()
        {
            return new TextParameters()
            {
                ...
                ScriptOffsetStart = ScriptOffsetStart,
            };
        }
        ...
        public void SetupDefaults()
        {
            ...
            ScriptOffsetStart = ScriptOffset;
        }
    }
    ...
    class FormatCodeItemIcon : FormatCodeIcon
    {
        ...
        public FormatCodeItemIcon(Guid objectID)
        {
            ObjectID = objectID;
        }

        public override void Draw(Scene scene, Vector2 pos, TextParameters parameters)
        {
            var curio = Manager.GetCurio(ObjectID);
            if (curio != null && scene is SceneGame sceneGame)
            {
                curio.DrawIcon(sceneGame, pos + new Vector2(8, 8));
            }
        }
    }
    ...
    class FormatCodeSymbolIcon : FormatCodeIcon
    {
        ...
        public override void Draw(Scene scene, Vector2 pos, TextParameters parameters)
        {
            Symbol.DrawIcon(scene, pos, parameters, 1);
        }
    }
    ...
    class FormatCodeBar : FormatCodeIcon
    {
        ...
        public override void Draw(Scene scene, Vector2 pos, TextParameters parameters)
        {
            Symbol.DrawIcon(scene, pos, parameters, Slide);
        }
    }
    ...
    abstract class FormatCodeIcon : FormatCode
    {
        ...
        public abstract void Draw(Scene scene, Vector2 pos, TextParameters parameters);
    }
    ...
    class IconMachine : CharacterMachine
    {
        ...
        protected StringBuilder symbolBuffer = new StringBuilder(GUID_LENGTH);

        public override bool Done => symbolBuffer.Length >= GUID_LENGTH;
        ...
        public override FormatCode GetResult()
        {
            Guid objectID = symbolBuffer.ToGuid();
    ...
    abstract class SymbolBaseMachine : CharacterMachine
    {
    ...
    class SymbolMachine : SymbolBaseMachine
    {
        public override FormatCode GetResult()
        {
    ...
    class BarMachine : SymbolBaseMachine
    {
        ...
        private static void DrawLine(IEnumerable<object> tokens, ref int index, TextParameters parameters, Vector2 drawpos, Game game)
        {
            ...
            foreach (var token in tokens)
            {
                ...
                if (token is FormatCode code)
                {
                    ...
                    {
                        icon.Draw(game.Scene, drawpos + new Vector2(x, 0) + parameters.Offset(index), parameters);
                    }
                ...
                else
                {
                    switch (chr)
                    {
                        ...
                        case (Game.FORMAT_BAR):
                            ...
                            machine.Reset();
                            break;
                        case (Game.FORMAT_RESET):
                            pushString();
                            tokens.Add(FormatToken.Reset);
                            break;
                        default:
                            builder.Append(chr);
                            break;
