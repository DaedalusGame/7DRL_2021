...
namespace _7DRL_2021
{
    ...
    class Game : Microsoft.Xna.Framework.Game
    {
        ...
        public const char FORMAT_RESET = (char)(FORMAT_CODES_BEGIN + 10);
        ...
        public static string FormatIcon(ICurio curio)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append(FORMAT_ICON);
            builder.Append(StringUtil.ToFormatString(curio.GlobalID));
